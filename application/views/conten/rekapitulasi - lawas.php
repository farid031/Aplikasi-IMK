                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-12 text-right">
                                    ...
                                    ?>
                                    <div class="huge"><?php echo 'Rp '.number_format($jumlah).',-'; ?></div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 text-right">
                                    <?php
                                        $query = $this->db->query("SELECT SUM(jml_setor) AS total FROM epasar");
                                        foreach ($query->result() as $row) {
                                            $jumlah_bln = $row->total;
                                        }
                                    ?>
                                    <div class="huge"><?php echo "Rp ".number_format($jumlah_bln).",-"; ?></div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                    ...
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
                            <div style="align-content: center; font-size: 16px">
                                ...
                                ?>
                                <div class="huge"><?php foreach($jml_setor->result() as $row){
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php
                        ...
                        <?php }
                    ?>
                    <?php echo form_open_multipart('Rekapitulasi/import_excel');?>
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center"><?php echo "Rp.".number_format($row->jml_setor, 0, ",", "."); ?></td>
