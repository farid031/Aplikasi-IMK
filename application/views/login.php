...
<div class="row" align="center">
  ...
  <div class="container">
    <div>
    <form class="form-signin2" style="color: snow"><br><br>
      <img style="height: 280px; width: 400px;" align="center" src="<?php echo base_url('assets/images/jtp.png'); ?>"/><br>
      <p style="color: black; font-size: 30px; font-weight: bold; margin-top: 6px"><br>JAWA TIMUR PARK GROUP</p>
      <p style="color: black; font-size: 20px; margin-top: 4px">Jl. Kartika No.2, Sisir, Kec. Batu,<br> Kota Batu, Jawa Timur 65315</p>
    </form>
  </div>
    ...
    <form class="form-signin" action="<?php echo base_url('login/login_form');?>" method="POST">
      <h3 class="section-heading"><span>Aplikasi Monitoring Pendapatan</span></h3>
      <div class="row">
        <div class="column">
